// Aerotech H128W-14A Motor Mass Equivalent Model
// Solid PLA with steel rod cavity and retainer shoulder

// === MOTOR SPECIFICATIONS ===
motor_diameter = 29;      // mm
motor_length = 194;       // mm
motor_mass = 206;         // grams

// === AFT CLOSURE SHOULDER ===
shoulder_diameter = 32;   // mm (retainer catches this)
shoulder_thickness = 7;   // mm
...
// === CONSOLE OUTPUT ===
echo("========================================");
echo("  AEROTECH H128W-14A MASS EQUIVALENT");
echo("========================================");
